...
//		}
		...
		ViewGroup container = (ViewGroup) inflater.inflate(R.layout.fly_verify_demo_container, null);
	...
	private void initView() {
		...
		leftTv = findViewById(R.id.fly_verify_demo_title_bar_left);
		leftTv.setOnClickListener(this);
		rightIv = findViewById(R.id.fly_verify_demo_title_bar_right);
		rightIv.setOnClickListener(this);
		centerTv = findViewById(R.id.fly_verify_demo_title_bar_center);
		if (titleStyle != null) {
